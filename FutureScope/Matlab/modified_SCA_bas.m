...
% Enhanced plotting section for presentation
figure;
plot(Mvec, Ratebas, '-o', 'LineWidth', 3, 'MarkerSize', 10, 'MarkerFaceColor', 'auto', 'DisplayName', 'Baseline Rate');
hold on;
plot(Mvec, Ratebas_new, '-s', 'LineWidth', 3, 'MarkerSize', 10, 'MarkerFaceColor', 'auto', 'DisplayName', 'Improved Rate');
xlabel('Number of Secondary Users (M)', 'FontSize', 16, 'FontWeight', 'bold');
ylabel('Achievable Rate (bps/Hz)', 'FontSize', 16, 'FontWeight', 'bold');
title('Rate Comparison vs Number of Secondary Users', 'FontSize', 18, 'FontWeight', 'bold');
legend('Location', 'best', 'FontSize', 14, 'FontWeight', 'bold');
grid on;
set(gca, 'FontSize', 14, 'FontWeight', 'bold', 'LineWidth', 1.5); % Make axes bold and thicker
hold off;
